...
image2 = Image.open('Jorge & Jeff-1.jpg')
st.image(image2)
...
phone_title = '<p style="font-family:Optima; color:Creme; font-size: 42px;">Phone us: 07878882575</p>'
st.markdown(phone_title, unsafe_allow_html=True)
email_title = '<p style="font-family:Optima; color:Creme; font-size: 42px;">Email us: jjclothing@gmail.com</p>'
...
findusat_title = '<p style="font-family:Optima; color:Creme; font-size: 42px;">95 Oxford Street,DN32 7JE</p>'
